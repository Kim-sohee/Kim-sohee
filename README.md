...
<!-- 내용 부분 -->
## ✋ About me 🤚
#### 안녕하세요 웹 기반 시스템 개발을 하고 있는 개발자 김소희입니다.
로봇자동화공학을 전공하며 산업 자동화 시스템 전반에 대한 기초를 쌓았고, 이후 약 2년 6개월간 웹 개발자로 근무하며 JavaScript, Node.js, PHP 등을 활용한 웹 서비스 개발을 경험했습니다.

최근에는 Java 기반 백엔드 개발에 집중하며 웹 애플리케이션 구조와 서버 설계에 대한 이해를 넓혀왔고, 개인 프로젝트와 학습을 통해 꾸준히 역량을 확장하고 있습니다.

단순히 기능을 구현하는 것을 넘어, 시스템이 안정적으로 동작하고 유지되는 과정까지 고민하는 개발자가 되고자 합니다.

GitHub에는 그 과정과 기록을 남기고 있습니다.
...
<br>
  ...
  <!-- C# -->
  <img src="https://img.shields.io/badge/C샵-00599C?style=flat-square&logo=cplusplus&logoColor=white&Color=white"/>
  <!-- Python -->
